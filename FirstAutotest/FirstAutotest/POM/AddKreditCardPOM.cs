...
namespace FirstAutotest.POM
{
    class AddKreditCardPOM
    {
        ...
        private readonly static By _product = By.Id("products-orderby");
        private readonly static By _Hight = By.XPath("//option[@value='http://demowebshop.tricentis.com/gift-cards?orderby=11']");
        private readonly static By _btnAddToCartGift = By.XPath("//input[@class='button-2 product-box-add-to-cart-button']");
        private readonly static By _Name = By.Id("giftcard_4_RecipientName");
        ...
        private readonly static By _A_Z = By.XPath("//option[@value= 'http://demowebshop.tricentis.com/jewelry?orderby=5']");
        ...
        private readonly static By _billing_address_select = By.Id("billing-address-select");
        private readonly static By _CountryId = By.Id("BillingNewAddress_CountryId");
        private readonly static By _Value = By.XPath("//option[@value='1']");
        ...
        private readonly static By _BtnpickUp = By.XPath("//input[@onclick='Shipping.save()']");
        private readonly static By _paymentmethod = By.Id("paymentmethod_2");
        ...
        private readonly static By _CardValue = By.XPath("//option[@value='Visa']");
        ...
        public void product() {
            _driver.FindElement(_product).Click();
            Thread.Sleep(1000);
        }

        public void Hight()
        {
            _driver.FindElement(_Hight).Click();
            Thread.Sleep(1000);
        }

        public AddKreditCardPOM Name(string text)
        {
        ...
        public void A_Z() {
            _driver.FindElement(_A_Z).Click();
            Thread.Sleep(1000);
        }
        ...
        public void BtnpickUp() {
            _driver.FindElement(_BtnpickUp).Click();
            Thread.Sleep(2000);
        }
        ...
        public void CardValue() {
            _driver.FindElement(_CardValue).Click();
        } 
        ...
        public void Clear() {
            _driver.FindElement(_CardholderName).Clear();
            _driver.FindElement(_CardNumber).Clear();
            _driver.FindElement(_CreditCard).Clear();
        }
